            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow-sm sm:rounded-lg p-6">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody>
                            <tr
                                v-for="partida in partidasLocal"
                                v-if="partida && partida.id"
                                :key="partida.id"
                                class="border-b"
                            >
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    <span
                                        v-else-if="partida.estado === 'esperando'"
                                ...
                                <td class="px-4 py-2">
                                    <button
                                        ...
                                        :disabled="(partida.usuarios?.length ?? 0) >= 2 || partida.estado !== 'esperando'"
                            ...
                            <tr v-if="partidasLocal.length === 0">
